        ...
        value: function getAllYValues() {
            ...
            if (this.barOptions.stacked) {
                ...
                this.data.datasets.map(function (d, i) {
                    var values = _this3.data.datasets[i].values;
            ...
            if (multiAxis) {
                this.data.datasets.map(function (d) {
                    ...
                    allValueLists[d.axisID || key] ? (_allValueLists = allValueLists[d.axisID || key]).push.apply(_allValueLists, toConsumableArray(d[key])) : allValueLists[d.axisID || key] = d[key];
                });
