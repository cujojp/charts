        ...
        value: function calcYAxisParameters(dataValues) {
            ...
            if (dataValues instanceof Array) {
                ...
                var _loop = function _loop(key) {
                    ...
                    var yAxisConfigObject = _this2.config.yAxisConfig.filter(function (item) {
                        return key === item.id;
                    }) || [];
                    var yAxisAlignment = yAxisConfigObject.length ? yAxisConfigObject[0].position : 'right';
